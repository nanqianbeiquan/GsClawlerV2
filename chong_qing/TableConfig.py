...
ji_ben_dict = {
    ...
    'province': 'province',
    'name': 'legalrepresentative',   # 法人代表
    'enttype_cn': 'enterprisetype',     # 企业类型
    ...
    'regorg_cn': 'registrationinstitution',   # 登记机构
    'apprdate': 'approvaldate',           # 核准日期
    'regstate_cn': 'registrationstatus',  # 状态
    'pril': 'principal',
    'oploc': 'businessplace',
...
gu_dong_renjiao_dict = {
    'conform_cn': 'subscripted_method',  # 认缴出资方式modify by guan
    'subconam': 'subscripted_amount',  # 认缴出资额（万元）modify by guan
    'condate': 'subscripted_time',  # 认缴出资日期  山东
    }

gu_dong_shijiao_dict = {
    'conform_cn': 'actualpaid_method',  # 实缴出资方式 modify by guan
    'acconam': 'actualpaid_amount',  # 实缴出资额（万元）
    'condate': 'actualpaid_time'  # 实缴出资日期 modify by guan
}
...
dong_chan_di_ya_dict = {
    ...
    'morreg_id': 'chattelmortgage_details'    # 详情
}
...
gu_quan_chu_zhi_dict = {
    ...
    'type_text': 'equitypledge_status',  # 状态 modify by guan  1 代表【有效】
    'publicdate': 'equitypledge_announcedate',  # 公示时间
...
jing_ying_yi_chang_dict = {
    ...
    'decorg_cn': 'abnormal_decisioninstitution'  # 作出决定机关
}
