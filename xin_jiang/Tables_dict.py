...
jiben_column_dict = {u'统一社会信用代码/注册号': 'Registered_Info:registrationno',
            ...
            u'首席代表': 'Registered_Info:legalrepresentative',         # new in xinjiang
            ...
            u'驻在场所': 'Registered_Info:residenceaddress',                # new in xinjiang
            ...
            u'经营(驻在)期限自': 'Registered_Info:validityfrom',             # new in xinjiang
            u'经营(驻在)期限至': 'Registered_Info:validityto',                 # new in xinjiang
            ...
            u'派出企业名称': 'Registered_Info:enterpriseassigning',                # new in xinjiang
