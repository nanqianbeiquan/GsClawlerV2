...
ji_ben_dict = {
    ...
    u'省份': 'province',
    u'经营状态': 'entstatus',
    u'经营(驻在)期限自': 'validityfrom',
    u'经营(驻在)期限至': 'validityto'
}
...
fen_zhi_ji_gou_dict = {
    ...
    u'序号': 'branch_no',
    u'注册号/统一社会信用代码': "branch_registrationno"
}
...
dong_chan_di_ya_dict = {
    ...
    u'公示日期': 'chattelmortgage_announcedate'  # 公示时间
}
...
xing_zheng_chu_fa_dict = {
    ...
    u'行政处罚内容（万元）': 'penalty_decisioncontent',  # 行政处罚内容
...
jing_ying_yi_chang_dict = {
    u'标记经营异常状态原因': 'abnormal_events',  # 列入经营异常名录原因
    u'列入经营异常名录原因': 'abnormal_events',
    u'标记日期': 'abnormal_datesin',  # 列入日期
    u'列入日期': 'abnormal_datesin',
    u'恢复正常记载状态原因': 'abnormal_moveoutreason',  # 移出经营异常名录原因
    u'移出经营异常名录原因': 'abnormal_moveoutreason',
    u'恢复日期': 'abnormal_datesout',  # 移出日期
    u'移出日期': 'abnormal_datesout',
