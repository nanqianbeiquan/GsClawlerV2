...
jiben_column_dict = {u'统一社会信用代码/注册号': 'Registered_Info:registrationno',
            ...
            u'企业名称': 'Registered_Info:enterprisename',                          # new in Qinghai 20161212
...
gudong_column_dict = {u'股东类型': 'Shareholder_Info:shareholder_type',
                      ...
                      u'发起人类型':'Shareholder_Info:shareholder_type',
                       ...
                       u'序号':'Shareholder_Info:shareholder_no',
                      }
...
hehuoren_column_dict = {u'合伙人类型':'Partner_Info:partner_type',
                        ...
                        u'公示日期':'Partner_Info:lastupdatetime',
...
DICInfo_column_dict = {u'序号':'DIC_Info:dic_no',
                        ...
                        u'公示日期':'DIC_Info:lastupdatetime',
...
biangeng_column_dict = {u'变更事项':'Changed_Announcement:changedannouncement_events', 
                         ...
                         u'序号':'Changed_Announcement:changedannouncement_no',                  # new in Qinghai 3rd vers website
                        }
...
guquanchuzhidengji_column_dict = {u'序号':'Equity_Pledge:equitypledge_no', 
                                  ...
                                  u'详情':'Equity_Pledge:equitypledge_details',  # 1108 new in 安徽华隆塑料有限责任公司
                                  }
...
jingyingyichang_column_dict = {u'序号':'Business_Abnormal:abnormal_no', 
                               ...
                               u'作出决定机关（移出）':'Business_Abnormal:abnormal_decisioninstitution(out)',
                               u'作出决定机关（标记）':'Business_Abnormal:abnormal_decisioninstitution(in)',
                               u'作出决定机关（恢复）':'Business_Abnormal:abnormal_decisioninstitution(out)',
                               }

yanzhongweifa_column_dict = {u'序号':'Serious_Violations:serious_no',
                             u'类别':'Serious_Violations:serious_type',   # new in 3rd vers website eg 大柴旦国华实业有限公司  in 20161213
                             u'列入严重违法企业名单原因':'Serious_Violations:serious_events',
                             u'列入严重违法失信企业名单（黑名单）原因':'Serious_Violations:serious_events',
                             u'列入严重违法失信企业名单(黑名单)原因':'Serious_Violations:serious_events',
                             ...
                             u'作出决定机关（列入）':'Serious_Violations:serious_decisioninstitution(in)',            # new in 3rd vers website eg 大柴旦国华实业有限公司  in 20161213
                             u'作出决定机关（移出）':'Serious_Violations:serious_decisioninstitution(out)',          # new in 3rd vers website eg 大柴旦国华实业有限公司  in 201612
                             }
...
qiyenianbaozichanzhuangkuang_column_dict = {u'公司名称': 'industry_status:enterprisename',
                                            ...
                                            u'所得者权益合计': 'industry_status:qyhj',
...
qiyenianbaoduiwaidanbao_column_dict = {u'公司名称': 'guarantee:enterprisename',
                                       u'序号': 'guarantee:xh',  # 1108 new in 颍上县艺之家装饰工程有限公司
                                       u'债权人': 'guarantee:zqr',
                                       u'债务人': 'guarantee:zwr',
...
qiyenianbaoguquanbiangeng_column_dict = {u'公司名称': 'equity_transfer:enterprisename',
                                         u'序号': 'equity_transfer:xh',  # 1108 new in 合肥浍溪新能源汽车技术有限公司
